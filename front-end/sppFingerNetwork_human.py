...
def train(trainArgs):
    ...
    for i in range(trainArgs['epochs']):
        ...
        for batch_idx, (cmp_dm, finger, word2vecProtein, n2vc, n2vp, y) in enumerate(train_loader):
            ...
            y_pred = attention_model(cmp_dm, finger, word2vecProtein, n2vc, n2vp)
            # penalization AAT - I
        # -----
...
if __name__ == "__main__":
    ...
    trian_proteinDataset = load_tensor(protein_file_path, torch.FloatTensor)    # protein doc2vec
